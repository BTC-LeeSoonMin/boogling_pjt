...
const Search = ({ item }) => {
  ...
  useEffect(() => {
    ...
    if (searchValue != "") {
      ...
      const filteredregion = AptOriginalArray.filter(
        (ele) => ele.AptRegion == region
      );
      console.log("filteredregion =====> ", filteredregion.length);
  ...
  return (
    <section>
      <div className="search_main">
        ...
        <div className="page">
          <Paging
            totalCount={AptFilteredArray.length}
            page={page}
